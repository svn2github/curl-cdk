...
====================
CDK Data Services Release 1.2 for Curl API Version 8.0
====================

This directory contains the 1.2 release of the Curl Data Kit Data
...
- COM.CURL.CDK.DATA-SERVICES.1.2/manifest.mcurl   	
