...
====================
CDK Release 1.0 for Curl API Version 6.0. 
====================

This directory contains the 1.0 release of the Curl Data Kit (CDK)
...
- COM.CURL.CDK.1.0/manifest.mcurl   	CDK library definition
...
- COM.CURL.CDK.1.0/manifest.mcurl   	CDK library doc definition
